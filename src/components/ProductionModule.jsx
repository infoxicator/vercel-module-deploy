...
export const ProductionModule = ({ switchLanguage, languageData, localeName }) => {
...
ProductionModule.childRoutes = childRoutes;
...
if (!global.BROWSER) {
  ...
  ProductionModule.appConfig = require('../appConfig').default;
}

ProductionModule.propTypes = {
...
export const mapDispatchToProps = (dispatch) => ({
  switchLanguage: async ({ target }) => {
    ...
    await dispatch(loadLanguagePack('production-module', { fallbackLocale: 'en-US' }));
  },
});
...
export const mapStateToProps = (state) => {
  ...
  const languagePack = state.getIn(
    ['intl', 'languagePacks', localeName, 'production-module'],
    fromJS({})
  ).toJS();
...
export const loadModuleData = ({ store: { dispatch } }) => dispatch(loadLanguagePack('production-module', { fallbackLocale: 'en-US' }));

ProductionModule.holocron = {
  name: 'production-module',
  loadModuleData,
};

export default connect(mapStateToProps, mapDispatchToProps)(ProductionModule);
